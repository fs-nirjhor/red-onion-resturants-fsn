...
return (
	<Row >
	   ...
	   <Col xs={12} md={4} className="rounded-4 background-whitesmoke d-flex align-content-around flex-wrap">
	      ...
	      <Button variant="danger" className="w-100 m-1">Contact</Button>
	   </Col>
	</Row>
);
};
